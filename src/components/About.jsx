    				...
    				<form action="#" class="appointment">
    					<div class="row">
			              ...
			              <input type="text" class="form-control" placeholder="Your Name"></input>
								...
								<div class="col-md-6">
									<div class="form-group">
			              <input type="text" class="form-control" placeholder="Vehicle number"></input>
			            </div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
			            		...
			            		<input type="text" class="form-control appointment_date" placeholder="Date"></input>
		            		</div>
			    				</div>
								</div>
								<div class="col-md-6">
			            		...
			            		<input type="text" class="form-control appointment_time" placeholder="Time"></input>
		            		</div>
			    				</div>
								</div>
								<div class="col-md-12">
			              ...
			              <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Message"></textarea>
								...
								<div class="col-md-12">
									<div class="form-group">
			              <input type="submit" value="Send message" class="btn btn-dark py-3 px-4"></input>
			            </div>
								</div>
    					</div>
	          </form>
