      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
              ...
              </p> <span>Blog Single <i class="fa fa-chevron-right"></i></span></div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
          	<p>
              <img src="images/image_1.jpg" alt="" class="img-fluid"></img>
            </p>
            ...
            <p>
              <img src="images/image_2.jpg" alt="" class="img-fluid"></img>
            </p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5">
                <img src="images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4"></img>
              </div>
              <div class="desc">
            ...
            <div class="pt-5 mt-5">
              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form action="#" class="p-5 bg-light">
                  ...
                  <div class="form-group">
                    <input type="submit" value="Post Comment" class="btn py-3 px-4 btn-primary"></input>
                  </div>
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            <div class="sidebar-box">
              <form action="#" class="search-form">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Type a keyword and hit enter"></input>
                </div>
              </form>
            </div>
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="tagcloud">
                ...
                <a href="#" class="tag-cloud-link">automotive</a>
                <a href="#" class="tag-cloud-link">mechanics</a>
                <a href="#" class="tag-cloud-link">engine</a>
                <a href="#" class="tag-cloud-link">paint</a>
                <a href="#" class="tag-cloud-link">tire</a>
              </div>
            </div>
